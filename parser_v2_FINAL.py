...
class ECGScanpathParserV2:
    ...
    def _classify_by_partial_score(self, partial_features: Dict, full_parse: bool) -> str:
        ...
        # Intermediate criteria (generous to avoid false novice classification)
        # A resident who completes 50%+ of systematic steps
        if score >= 0.50 or coverage >= 0.70:
            return 'intermediate'
        
        # Also intermediate if they have systematic start but incomplete
        if has_initial and has_axis and has_components and score >= 0.35:
            return 'intermediate'
